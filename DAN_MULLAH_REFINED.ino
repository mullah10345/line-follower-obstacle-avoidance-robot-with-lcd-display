...
#define MAX_DISTANCE 300 // Maximum distance for ultrasonic sensor
LiquidCrystal_I2C lcd(0x27, 20, 4);
#define enA 3 // Enable1 L298 Pin enA
#define in1 4 // Motor1 L298 Pin in1
#define in2 2 // Motor1 L298 Pin in2
#define in3 6 // Motor2 L298 Pin in1
#define in4 7 // Motor2 L298 Pin in2
...
void lineTrack()
{
  ...
  if ((leftSensor == HIGH && rightSensor == HIGH) || (leftSensor == LOW && rightSensor == LOW)) {
    forword();
  }
